...
class ArucoNode(Node):
  ...
  def __init__(self):
    ...
    self.declare_parameter("camera_calibration_parameters_filename", "/home/skander/Documents/aruco_ws/src/opencv_tools/opencv_tools/calibration_chessboard.yaml")
